        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-xl animate-fade-in">
          ...
          <div className="relative max-w-2xl w-full rounded-3xl glass-dark border border-slate-800 p-6 sm:p-8 z-10 max-h-[85vh] overflow-y-auto space-y-4 text-xs text-slate-300">
            ...
            <div className="space-y-3 leading-relaxed">
              ...
              <p>
                <strong>2. Usage Quotas & Tiers:</strong> Zulora AI applies a rolling daily token allocation across chat, image, and video generation. A short burst cooldown may pause requests for five minutes to maintain service quality. The available capacity varies by plan and is shown as a usage percentage with its reset time. Abuse or automated scraping is strictly prohibited.
              </p>
              <p>
